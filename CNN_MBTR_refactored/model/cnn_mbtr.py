...
def cnn_mbtr(filters_list, outdim, cost, input_dims = None, activation="rectify", **kwargs):
    ...
    layer_input_dims = [None] # batch_size
    layer_input_dims.extend([1, input_dims]) # channels, 1 spatial dimension
    ...
    for idx, num_filters in enumerate(filters_list):
            layers.append(Conv1DLayer(layers[-1],
            ...
            layers.append(MaxPool1DLayer(layers[-1],
                pool_size = 2,
